...
export const chatAPI = {
  lecture: (lessonId, message, sessionId = null) => 
    apiClient.post('/chat/lecture', { lesson_id: lessonId, message, session_id: sessionId }),
  examStart: (lessonId) => apiClient.post('/chat/exam/start', { lesson_id: lessonId }),
  examFinish: (sessionId, message) => apiClient.post('/chat/exam/finish', { session_id: sessionId, message }),
  consultant: (message, sessionId = null) => 
    apiClient.post('/chat/consultant', { message, session_id: sessionId }),
