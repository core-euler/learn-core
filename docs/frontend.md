...
- Ответы должны сопровождаться ссылкой на источник урока/модуля.
...
## 12) Limits & Errors UX
- При превышении лимитов показывается отдельный тип сообщения с указанием времени/условия сброса.
